...
**Приспособление** или адаптация являются важными стратегиями для разрешения конфликтов. Данная стратегия может иметь следующие преимущества при выходе из конфликтной ситуации:
